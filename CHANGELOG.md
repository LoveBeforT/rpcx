...
- move zookeeper plugin to https://github.com/LoveBeforT/rpcx-zookeepr
- move consul plugin to https://github.com/LoveBeforT/rpcx-consul
- move redis plugin to https://github.com/LoveBeforT/rpcx-redis
- move influxd/opentelemetry plugin to https://github.com/LoveBeforT/rpcx-plugins
...
- Add [rpcx-java](https://github.com/LoveBeforT/rpcx-java) to support develop raw java services and clients
...
- Add English document: https://github.com/LoveBeforT/rpcx-programming
